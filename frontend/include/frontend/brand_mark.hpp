...
{
    /**
     * @brief Inline NuiSftp brand mark — a path + polygon filled with
     * `currentColor` so the parent element's `color:` controls the tint and
     * any `filter: drop-shadow(...)` on the parent applies cleanly.
     */
