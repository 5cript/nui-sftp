...
{
    on("RpcFilesystem::remove").perform([this](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
        ...
        Log::info("Successfully recursively removed path: {} ({} files/directories removed)", path, filesRemoved);
...
void RpcFilesystem::registerRemoveMultiple()
{
    on("RpcFilesystem::removeSome").perform([this](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
        ...
        if (!RpcHelper::ParameterVerifyView{reply, "RpcFilesystem::removeSome", parameters}.hasValueDeep("paths"))
        {
...
{
    on("RpcFilesystem::listFiles").perform([](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
...
void RpcFilesystem::registerCreateFile()
{
    on("RpcFilesystem::createFile").perform([this](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
        ...
        if (!RpcHelper::ParameterVerifyView{reply, "RpcFilesystem::createFile", parameters}.hasValueDeep("filePath"))
        {
...
void RpcFilesystem::registerCreateDirectory()
{
    on("RpcFilesystem::createDirectory").perform([this](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
        ...
        if (!RpcHelper::ParameterVerifyView{reply, "RpcFilesystem::createDirectory", parameters}.hasValueDeep("path"))
        {
...
{
    on("RpcFilesystem::properties").perform([](RpcHelper::RpcOnce&& reply, nlohmann::json const& parameters) {
        Log::info("RpcFilesystem::properties called with parameters: {}", parameters.dump(4));

        if (!RpcHelper::ParameterVerifyView{reply, "RpcFilesystem::properties", parameters}.hasValueDeep("path"))
        {
